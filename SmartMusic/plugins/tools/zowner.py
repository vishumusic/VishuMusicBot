...
from SmartMusic.mongo.afkdb import LOGGERS as OWNERS
from SmartMusic.utils.database import add_served_chat, get_assistant
...
async def add_allbot(client, message):
    ...
    if len(command_parts) != 2:
        await message.reply(
            "**⚠️ ɪɴᴠᴀʟɪᴅ ᴄᴏᴍᴍᴀɴᴅ ғᴏʀᴍᴀᴛ. ᴘʟᴇᴀsᴇ ᴜsᴇ ʟɪᴋᴇ » `/gadd @SamiraMusiccBot`**"
        )
        return
